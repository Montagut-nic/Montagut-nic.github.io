...
function evaluateExcessIdeasInGroup(groupPercentage, groupValueSelectorString){
	var warningMessage = "Si más del 50% de los niveles de ideas pertenecen al mismo grupo, esas ideas costarán más!";
	if(initComplete){
		if(groupPercentage > 50){
			...
			toastr["warning"](warningMessage, "Más del 50% en un mismo grupo de ideas");
		}else{
...
function updateAvailablePoints(){
	...
	if($("#available-points-value").val() < 0){
		...
		toastr["error"]("Has gastado más puntos que los que hay disponibles", "Puntos Negativos")
	}else{	
